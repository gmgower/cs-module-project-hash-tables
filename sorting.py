# 3 Next we explored why it doesn't really make sense to sort dictionaries, and why in general hash tables don't keep things in the same order you put them in. And we figured out how to sort keys and values anyway.
...
# Why not?
## Hash function scrambles key to unpredictable indices
